...
def call_stored_procedure(**kwargs):
    ...
    querys = ["SET TIME ZONE 'Asia/Seoul';",
              "call stoa_on.sp_m_vision_pgm_schedule_time_detail_min_viewer_current_daily_upload('{}', '{}');".format(start_datetime, end_datetime)]
...
with DAG(
    dag_id="dags_python_with_redshiftsqlhook_sp_m_vision_pgm_schedule_time_detail_min_viewer_current_daily_upload",
